...
def createLargerASPPHead(in_channels, classes):
    return LargerASPPHead(in_channels, classes)
...
def createDecoder(decoder_name, in_channels, classes):
    ...
    elif decoder_name == 'LargerASPP':
        return createLargerASPPHead(in_channels, classes)

class EVFRNet(torch.nn.Module):
    def __init__(self, stage,
                 decoder1,
                 decoder2,
                 ckpt_path = None):
        super(EVFRNet, self).__init__()
